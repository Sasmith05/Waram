      ...
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-slate-100 flex items-center justify-center select-none">
        {property.images && property.images.length > 0 ? (
          ...
          <div className="w-full h-full bg-slate-50 flex flex-col items-center justify-center p-4 text-center border-b border-slate-100">
            ...
            <span className="text-slate-400 font-bold text-xs uppercase tracking-wider">No Images Available</span>
          </div>
        )}
        ...
        <span className="absolute top-4 left-4 bg-slate-900/90 backdrop-blur-xs text-white text-[10px] sm:text-xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-lg border border-white/10">
          {property.categoryDisplay || property.property_type.replace("-", " ")}
        </span>
