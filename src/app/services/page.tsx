    ...
    <div className="relative pt-20 pb-16 bg-white text-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <span className="text-xs uppercase tracking-widest text-gold-600 font-bold font-sans">Practice Scope</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                  ...
                  <div className="lg:col-span-5 space-y-4 font-sans">
                    ...
                    <div className="pt-4 font-sans">
                      <Link
                        href="/contact"
                        className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-gold-600 font-bold hover:text-slate-900 transition-colors duration-200"
                      >
        ...
        >
          ...
          <p className="text-slate-600 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed font-sans">
            Advocate S Rajasekar is available for consultation and document drafting by appointment. Book your schedule or speak directly on WhatsApp.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2 font-sans">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-gold-400 to-gold-600 hover:from-gold-500 hover:to-gold-700 text-white font-bold rounded-lg transition-colors duration-200 text-sm shadow-sm active:scale-95"
            >
              <PhoneCall className="h-4 w-4" />
              Schedule Appointment
            </Link>
            <a
              href={`https://wa.me/${contactInfo.whatsappNumber}?text=Hello%20Advocate%20S%20Rajasekar`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border border-slate-200 text-slate-700 font-semibold rounded-lg hover:border-gold-500 hover:bg-slate-50 transition-colors duration-200 text-sm active:scale-95 shadow-sm"
            >
